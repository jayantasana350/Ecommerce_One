    ...
    <div class="br-section-wrapper">
        ...
        <div id="exTab1" class="container">
            <ul  class="nav nav-pills">
                        <li class="active">
                    <a  href="#1a" data-toggle="tab" class="btn btn-info mg-l-4">All Users</a>
                        </li>
                        <li><a href="#2a" data-toggle="tab" class="btn btn-info mg-l-4">Roles</a>
                        </li>
                        <li><a href="#3a" data-toggle="tab" class="btn btn-info mg-l-4">Permissions</a>
                        </li>
                      <li><a href="#4a" data-toggle="tab" class="btn btn-info mg-l-4">Trushed</a>
                        </li>
                    </ul>
